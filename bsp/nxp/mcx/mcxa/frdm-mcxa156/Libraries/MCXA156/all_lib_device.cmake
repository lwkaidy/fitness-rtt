...
#set.board.frdmmcxa156
#  # description: Board_project_template frdmmcxa156
...
#  # description: Device MCXA156_cmsis
#  set(CONFIG_USE_device_CMSIS true)

#  # description: Device MCXA156_system
#  set(CONFIG_USE_device_system true)

#  # description: Device MCXA156_startup
...
#set.middleware.safety
#  # description: NXP Safety IEC60730B Library
#  set(CONFIG_USE_middleware_safety true)
...
#  set(CONFIG_USE_middleware_motor_control_mc_drivers_adc_mcxa_epwm_float true)
...
#set.middleware.canopennode
#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode true)

#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode_301 true)

#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode_303 true)

#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode_304 true)

#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode_305 true)

#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode_309 true)

#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode_extra true)

#  # description: CANopen protocol stack
#  set(CONFIG_USE_middleware_canopennode_storage true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxa156/project_template
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/canopennode/protocol
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/safety_iec60730b
...
include_if_use(component_at_least_one_i2c_mux_device_enabled.MCXA156)
include_if_use(component_button.MCXA156)
include_if_use(component_common_task)
include_if_use(component_ctimer_adapter.MCXA156)
include_if_use(component_ctimer_time_stamp_adapter.MCXA156)
include_if_use(component_enable_pca9544.MCXA156)
include_if_use(component_enable_pca9548.MCXA156)
include_if_use(component_flash_adapter.MCXA156)
include_if_use(component_flash_nor_lpspi.MCXA156)
include_if_use(component_gpio_adapter.MCXA156)
include_if_use(component_i2c_adapter_interface.MCXA156)
include_if_use(component_i2c_mux_pca954x.MCXA156)
include_if_use(component_i3c_adapter.MCXA156)
include_if_use(component_i3c_bus.MCXA156)
include_if_use(component_i3c_bus_adapter.MCXA156)
include_if_use(component_led.MCXA156)
include_if_use(component_lists.MCXA156)
include_if_use(component_lpi2c_adapter.MCXA156)
include_if_use(component_lpspi_adapter.MCXA156)
include_if_use(component_lptmr_adapter.MCXA156)
include_if_use(component_lptmr_time_stamp_adapter.MCXA156)
include_if_use(component_lpuart_adapter.MCXA156)
include_if_use(component_mcxw_flash_adapter.MCXA156)
include_if_use(component_mem_manager.MCXA156)
include_if_use(component_mem_manager_freertos.MCXA156)
include_if_use(component_mem_manager_legacy.MCXA156)
include_if_use(component_mem_manager_light.MCXA156)
include_if_use(component_messaging.MCXA156)
include_if_use(component_mflash_offchip.MCXA156)
include_if_use(component_mflash_onchip.MCXA156)
...
include_if_use(component_ostimer_adapter.MCXA156)
include_if_use(component_ostimer_time_stamp_adapter.MCXA156)
include_if_use(component_panic.MCXA156)
include_if_use(component_reset_adapter.MCXA156)
include_if_use(component_serial_manager.MCXA156)
include_if_use(component_serial_manager_spi.MCXA156)
include_if_use(component_serial_manager_swo.MCXA156)
include_if_use(component_serial_manager_uart.MCXA156)
include_if_use(component_serial_manager_usb_cdc.MCXA156)
include_if_use(component_serial_manager_virtual.MCXA156)
include_if_use(component_timer_manager.MCXA156)
include_if_use(device_CMSIS.MCXA156)
include_if_use(device_RTE.MCXA156)
include_if_use(device_project_template.MCXA156)
include_if_use(device_startup.MCXA156)
include_if_use(device_system.MCXA156)
include_if_use(driver_aoi.MCXA156)
include_if_use(driver_cache_lpcac_n4a_mcxn.MCXA156)
include_if_use(driver_camera-common.MCXA156)
include_if_use(driver_camera-device-ap1302.MCXA156)
include_if_use(driver_camera-device-common.MCXA156)
include_if_use(driver_camera-device-max9286.MCXA156)
include_if_use(driver_camera-device-mt9m114.MCXA156)
include_if_use(driver_camera-device-ov5640.MCXA156)
include_if_use(driver_camera-device-ov7670.MCXA156)
include_if_use(driver_camera-device-ov7725.MCXA156)
include_if_use(driver_camera-device-sccb.MCXA156)
include_if_use(driver_camera-receiver-common.MCXA156)
include_if_use(driver_cdog.MCXA156)
include_if_use(driver_clock.MCXA156)
include_if_use(driver_cmsis_gpio.MCXA156)
include_if_use(driver_cmsis_lpi2c.MCXA156)
include_if_use(driver_cmsis_lpspi.MCXA156)
include_if_use(driver_cmsis_lpuart.MCXA156)
include_if_use(driver_common.MCXA156)
include_if_use(driver_crc.MCXA156)
include_if_use(driver_ctimer.MCXA156)
include_if_use(driver_dac_1.MCXA156)
include_if_use(driver_dbi.MCXA156)
include_if_use(driver_dbi_flexio_edma.MCXA156)
include_if_use(driver_dc-fb-common.MCXA156)
include_if_use(driver_dc-fb-dbi.MCXA156)
include_if_use(driver_dc-fb-ssd1963.MCXA156)
include_if_use(driver_display-adv7535.MCXA156)
include_if_use(driver_display-common.MCXA156)
include_if_use(driver_display-it6161.MCXA156)
include_if_use(driver_display-it6263.MCXA156)
include_if_use(driver_display-sn65dsi83.MCXA156)
include_if_use(driver_edma4.MCXA156)
include_if_use(driver_edma_soc.MCXA156)
include_if_use(driver_eim.MCXA156)
include_if_use(driver_ektf2k.MCXA156)
include_if_use(driver_eqdc.MCXA156)
include_if_use(driver_erm.MCXA156)
include_if_use(driver_fbdev.MCXA156)
include_if_use(driver_flexcan.MCXA156)
include_if_use(driver_flexcan_edma.MCXA156)
include_if_use(driver_flexio.MCXA156)
include_if_use(driver_flexio_i2c_master.MCXA156)
include_if_use(driver_flexio_mculcd.MCXA156)
include_if_use(driver_flexio_mculcd_edma.MCXA156)
include_if_use(driver_flexio_spi.MCXA156)
include_if_use(driver_flexio_spi_edma.MCXA156)
include_if_use(driver_flexio_uart.MCXA156)
include_if_use(driver_flexio_uart_edma.MCXA156)
include_if_use(driver_ft3267.MCXA156)
include_if_use(driver_ft5406.MCXA156)
include_if_use(driver_ft5406_rt.MCXA156)
include_if_use(driver_ft6x06.MCXA156)
include_if_use(driver_fxas21002cq.MCXA156)
include_if_use(driver_fxls8974cf.MCXA156)
include_if_use(driver_fxos8700cq.MCXA156)
include_if_use(driver_glikey.MCXA156)
include_if_use(driver_gpio.MCXA156)
include_if_use(driver_gt911.MCXA156)
include_if_use(driver_htu21d.MCXA156)
include_if_use(driver_i3c.MCXA156)
include_if_use(driver_i3c_edma.MCXA156)
include_if_use(driver_icm42688p.MCXA156)
include_if_use(driver_ili9341.MCXA156)
include_if_use(driver_inputmux.MCXA156)
include_if_use(driver_inputmux_connections.MCXA156)
include_if_use(driver_lpadc.MCXA156)
include_if_use(driver_lpc_freqme.MCXA156)
include_if_use(driver_lpcmp.MCXA156)
include_if_use(driver_lpi2c.MCXA156)
include_if_use(driver_lpi2c_edma.MCXA156)
include_if_use(driver_lpi2c_freertos.MCXA156)
include_if_use(driver_lpspi.MCXA156)
include_if_use(driver_lpspi_edma.MCXA156)
include_if_use(driver_lpspi_freertos.MCXA156)
include_if_use(driver_lptmr.MCXA156)
include_if_use(driver_lpuart.MCXA156)
include_if_use(driver_lpuart_edma.MCXA156)
include_if_use(driver_lpuart_freertos.MCXA156)
include_if_use(driver_lsm6dso.MCXA156)
include_if_use(driver_max30101.MCXA156)
include_if_use(driver_mcx_cmc.MCXA156)
include_if_use(driver_mcx_spc.MCXA156)
include_if_use(driver_mcx_vbat.MCXA156)
include_if_use(driver_mma8451q.MCXA156)
include_if_use(driver_mma8652fc.MCXA156)
include_if_use(driver_nmh1000.MCXA156)
include_if_use(driver_opamp.MCXA156)
include_if_use(driver_ostimer.MCXA156)
include_if_use(driver_p3t1755.MCXA156)
include_if_use(driver_port.MCXA156)
include_if_use(driver_psp27801.MCXA156)
include_if_use(driver_pwm.MCXA156)
include_if_use(driver_reset.MCXA156)
include_if_use(driver_romapi.MCXA156)
include_if_use(driver_rtt.MCXA156)
include_if_use(driver_rtt_template.MCXA156)
include_if_use(driver_ssd1963.MCXA156)
include_if_use(driver_st7796s.MCXA156)
include_if_use(driver_tma525b.MCXA156)
include_if_use(driver_trdc_1.MCXA156)
include_if_use(driver_trdc_soc.MCXA156)
include_if_use(driver_tsl2561.MCXA156)
include_if_use(driver_utick.MCXA156)
include_if_use(driver_video-common.MCXA156)
include_if_use(driver_video-i2c.MCXA156)
include_if_use(driver_waketimer.MCXA156)
include_if_use(driver_wuu.MCXA156)
include_if_use(driver_wwdt.MCXA156)
include_if_use(middleware_baremetal.MCXA156)
include_if_use(middleware_canopennode)
include_if_use(middleware_canopennode_301)
include_if_use(middleware_canopennode_303)
include_if_use(middleware_canopennode_304)
include_if_use(middleware_canopennode_305)
include_if_use(middleware_canopennode_309)
include_if_use(middleware_canopennode_extra)
include_if_use(middleware_canopennode_storage)
...
include_if_use(middleware_motor_control_mc_drivers_adc_mcxa_epwm_float)
...
include_if_use(middleware_safety)
...
include_if_use(utilities_misc_utilities.MCXA156)
include_if_use(utility_assert.MCXA156)
include_if_use(utility_assert_lite.MCXA156)
include_if_use(utility_debug_console.MCXA156)
include_if_use(utility_debug_console_lite.MCXA156)
include_if_use(utility_debug_console_template_config.MCXA156)
include_if_use(utility_format.MCXA156)
include_if_use(utility_incbin.MCXA156)
include_if_use(utility_shell.MCXA156)
include_if_use(utility_str.MCXA156)
